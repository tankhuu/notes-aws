...
- [x] https://www.atlassian.com/git/tutorials/using-branches
- [x] https://docs.aws.amazon.com/codecommit/latest/userguide/auth-and-access-control-iam-identity-based-access-control.html
